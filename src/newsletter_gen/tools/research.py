    ...
    def _run(self, search_query: str, start_datetime: datetime, end_datetime: datetime) -> str:
        ...
        try:
            search_results = exa.search_and_contents(
                query=search_query,
                use_autoprompt=True,
                start_published_date=start_datetime.isoformat(),
                end_published_date=end_datetime.isoformat(),
...
class GetContents(BaseTool):
    ...
    def _run(self, article_ids: list, start_datetime: datetime, end_datetime: datetime) -> str:
        exa = Exa(api_key=os.getenv("EXA_API_KEY"))
